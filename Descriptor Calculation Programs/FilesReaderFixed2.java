/*
 * This program formats the fixed, randomly generated inactive sequences in the file
 * InactiveSequencesFixed.txt and uses FeatureCalculator.java to find the descriptors of 
 * these inactive sequences
 */
import java.io.*;
import java.util.*;


public class FilesReaderFixed2
{
